...
Yolo::Yolo(String configuration, String model, String classesFile)
    : configuration(configuration), model(model), classesFile(classesFile)
{
...
Mat Yolo::detect(Mat frame)
{
    ...
    blobFromImage(frame, blob, 0.00392, cv::Size(Yolo::width, Yolo::height), Scalar(0, 0, 0), true, false);
    net.setInput(blob);
...
void Yolo::draw_box(int classId, float conf, int left, int top, int right, int bottom, Mat &frame)
{
